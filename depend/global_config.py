...
# __C.ROVIS_VISION.OBJECT_CLASSES_PATH = r'C:\dev\src\RovisLab\RovisDojo\data\fake_dataset\datastream_37\object_classes.conf'
...
# __C.DB.BASE_PATH = r'D:\dev\Adnotation\dataset_driving'
